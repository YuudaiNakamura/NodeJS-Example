...
angular.module('xenon.services', []).
	service('$menuItems', function()
	{
		...
		{
			var dashboard    = this.addItem('img by domain', 		'/app/home', 			'');
			var dashboard2    = this.addItem('img by id', 			'/app/home2', 			'');
			var dashboard3    = this.addItem('add item', 			'/app/home3', 			'');
			var dashboard4    = this.addItem('edit item', 			'/app/home4', 			'');
			var dashboard5    = this.addItem('stats',				'/app/home5',			'');
			return this;
		}
